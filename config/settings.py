...
EMAIL_PORT = config("EMAIL_PORT", default=2525, cast=int)  # Make sure this is cast as an integer
EMAIL_USE_TLS = config("EMAIL_USE_TLS", default=True, cast=bool)
EMAIL_HOST_USER = config("EMAIL_HOST_USER", default="141f0a4b49154c")
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD", default="86b4308a10a063")
EMAIL_FROM_ADDRESS = config("EMAIL_FROM_ADDRESS", default="admin@lms-analytics.com")
